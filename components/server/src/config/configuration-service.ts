...
export class ConfigurationService {
    ...
    async guessRepositoryConfiguration(
        ...
        return `# This configuration file was automatically generated by Devpod.
# Please adjust to your needs (see https://www.devpod.khulnasoft.com/docs/introduction/learn-devpod/devpod-yaml)
...
`;
    ...
    async fetchRepositoryConfiguration(
        ...
        const configString = await fileProvider.getDevpodFileContent(commitContext, user);
        return configString;
    }
