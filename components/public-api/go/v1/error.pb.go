...
type FailedPreconditionDetails struct {
	...
	//	*FailedPreconditionDetails_InvalidDevpodYml
...
func (x *FailedPreconditionDetails) GetInvalidDevpodYml() *InvalidDevpodYMLError {
	if x, ok := x.GetReason().(*FailedPreconditionDetails_InvalidDevpodYml); ok {
		return x.InvalidDevpodYml
	}
	return nil
}
...
type FailedPreconditionDetails_InvalidDevpodYml struct {
	InvalidDevpodYml *InvalidDevpodYMLError `protobuf:"bytes,4,opt,name=invalid_devpod_yml,json=invalidDevpodYml,proto3,oneof"`
}
...
func (*FailedPreconditionDetails_InvalidDevpodYml) isFailedPreconditionDetails_Reason() {}
...
type InvalidDevpodYMLError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InvalidDevpodYMLError) Reset() {
	*x = InvalidDevpodYMLError{}
	if protoimpl.UnsafeEnabled {
...
func (x *InvalidDevpodYMLError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvalidDevpodYMLError) ProtoMessage() {}

func (x *InvalidDevpodYMLError) ProtoReflect() protoreflect.Message {
	mi := &file_devpod_v1_error_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvalidDevpodYMLError.ProtoReflect.Descriptor instead.
func (*InvalidDevpodYMLError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{7}
}

func (x *InvalidDevpodYMLError) GetViolations() []string {
	if x != nil {
		return x.Violations
	}
	return nil
...
var file_devpod_v1_error_proto_goTypes = []interface{}{
	...
	(*InvalidDevpodYMLError)(nil),              // 7: devpod.v1.InvalidDevpodYMLError
...
var file_devpod_v1_error_proto_depIdxs = []int32{
	...
	7,  // 5: devpod.v1.FailedPreconditionDetails.invalid_devpod_yml:type_name -> devpod.v1.InvalidDevpodYMLError
...
func file_devpod_v1_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_devpod_v1_error_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InvalidDevpodYMLError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_devpod_v1_error_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*FailedPreconditionDetails_InvalidDevpodYml)(nil),
