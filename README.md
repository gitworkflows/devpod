...
- [**Secure**](https://www.devpod.io/security) - Each Devpod workspace or prebuild runs on a secured single-use container providing fast startup times without compromising on security. Devpod generates SLSA level 1 compliant provenance. Devpod is also GDPR and SOC2 compliant. And, of course, Devpod is open-source and available for review by everyone.
- **Workspaces based on Docker** - Devpod instantly starts a container in the cloud based on an (optional) [Docker image](https://www.devpod.io/docs/config-docker/). If you’re already using Docker, you can easily re-use your Docker file. 
- **GitLab, GitHub, Bitbucket and Azure DevOps integration** - Devpod seamlessly [integrates](https://www.devpod.io/docs/configure/authentication) into your workflow and works with all major Git hosting platforms including GitHub, GitLab, Bitbucket, and Azure DevOps.
...
- **Browser**: 
    - Using Devpod dashboard [devpod.io/new](https://devpod.io/new).
    - Add `devpod.io/# `as a prefix to any of your GitHub/ GitLab/ Bitbucket repository, like [this](https://devpod.io/#https://github.com/khulnasoft/template-typescript-react)
- **CLI**: You can also [install the Devpod CLI](https://www.devpod.io/docs/references/devpod-cli#installation) and create your first workspace directly from your terminal :)


## Documentation

All documentation can be found on [www.devpod.io/docs](https://www.devpod.io/docs). For example, see [Devpod tutorial](https://www.devpod.io/docs/introduction/devpod-tutorial) and check the following helpful resources:
...
For questions and support please use [Devpod community Discord](https://www.devpod.io/chat). Join the conversation, and connect with other community members. 💬
